...
String aboutus_screen_paragraph_3 =
  ...
  TextStyle aboutus_screen_heading_tstyle =const TextStyle(fontWeight: FontWeight.bold);
...
// Events screen
  ...
  TextStyle event_screen_date_tstyle =const TextStyle(fontSize: 15, fontWeight: FontWeight.bold);
...
// Newsletter screen
    ...
    TextStyle newsletter_screen_title_tstyle = const TextStyle(fontSize: 20, fontWeight: FontWeight.bold);
